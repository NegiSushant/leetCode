...
https://leetcode.com/problems/successful-pairs-of-spells-and-potions/?envType=study-plan-v2&id=leetcode-75
...
public class SuccessfulPairsOfSpellsAndPotions {
    public static void main(String[] args) {
        ...
        int[] p = {1,2,3,4,5};
        long suc = 7;
        System.out.println(Arrays.toString(successfulPairs(s, p, suc)));
